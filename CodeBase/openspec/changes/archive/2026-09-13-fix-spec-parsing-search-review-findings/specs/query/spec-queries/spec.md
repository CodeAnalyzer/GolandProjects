...
- **THEN** каждая возвращённая запись содержит непустой фрагмент текста именно своей сущности-источника
