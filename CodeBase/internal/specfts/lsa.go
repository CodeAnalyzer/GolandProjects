...
//	2: нормализация ё→е
//	3: стемминг Snowball (Russian) вместо суффиксного списка, рунные проверки
//	   длины (аббревиатуры ≤ 4 символов, минимальный стем 2 символа),
//	   стоп-словарь по стемам записей
